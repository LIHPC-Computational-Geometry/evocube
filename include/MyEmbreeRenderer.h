...
namespace igl
{
  namespace embree
  {
    ...
    public:
      ...
      void set_edges(const Eigen::MatrixXf& begs, const Eigen::MatrixXf& ends, const Eigen::MatrixXf& edge_colors){
        begs_ = begs;
        ends_ = ends;
        edge_colors_ = edge_colors;
      }

      void set_edges_per_tri(const std::vector<std::vector<int>>& edges_per_tri){
        edges_per_tri_ = edges_per_tri;
      }
    ...
    private:
      ...
      Eigen::MatrixXf begs_;
      Eigen::MatrixXf ends_;
      Eigen::MatrixXf edge_colors_;
      std::vector<std::vector<int>> edges_per_tri_;
